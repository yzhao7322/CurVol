...
3. basis.score - functional scores by projecting the squared process onto     given basis functions.
4. dgp.fgarch - generate functional data following the functional
    ARCH(1) or GARCH(1,1) process.
5. dgp.fiid - generate iid functional data following Ornstein–Uhlenbeck       process.
6. diagnostic.fGarch - estimation parameters as the inputs for diagnostic     purposes.
...
10. fun_hetero - test conditional heteroscedasticity for functional data.
