...
5. basis.tfpca - non-negative truncated functional principal
    components.
6. basis.score - functional scores by projecting the squared process onto     given basis functions.
7. dgp.fgarch - generate functional data following the functional
    ARCH(1) or GARCH(1,1) process.
8. dgp.fiid - generate iid functional data following Ornstein–Uhlenbeck       process.
9. diagnostic.fGarch - estimation parameters as the inputs for diagnostic     purposes.
...
13. fun_hetero - test conditional heteroscedasticity for functional data.
